      ...
      if(isset($_POST['id']) && empty($_POST['edit_mode']))
       {
        ...
        $dbr->bindParam(42, $_POST['template_mobile'], PDO::PARAM_STR);
        $dbr->bindParam(43, $_POST['language_file'], PDO::PARAM_STR);
        $dbr->bindParam(44, $_POST['content_type'], PDO::PARAM_STR);
        $dbr->bindParam(45, $_POST['charset'], PDO::PARAM_STR);
        $dbr->bindParam(46, $_POST['page_notes'], PDO::PARAM_STR);
        $dbr->bindParam(47, $edit_permission_list, PDO::PARAM_STR);
        $dbr->bindParam(48, $_POST['edit_permission_general'], PDO::PARAM_INT);
        $dbr->bindParam(49, $_POST['custom_values'], PDO::PARAM_STR);
        $dbr->bindParam(50, $_POST['status'], PDO::PARAM_INT);
        $dbr->bindParam(51, $_POST['id'], PDO::PARAM_INT);
        $dbr->execute();
       }
      else
       {
        ...
        $dbr->bindParam(49, $_POST['custom_values'], PDO::PARAM_STR);
        $dbr->bindParam(50, $_POST['status'], PDO::PARAM_INT);
        $dbr->bindParam(51, $_SESSION[$settings['session_prefix'].'user_id'], PDO::PARAM_INT);
        $dbr->execute();
       }
  ...
  switch($action)
   {
    case 'main':
     ...
     $handle=opendir(BASE_PATH.'templates/');
     ...
     $handle=opendir(BASE_PATH.CMS.'lang/');
     while($file = readdir($handle))
      {
